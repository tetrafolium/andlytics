...
private static final String POST_REQUEST_GET_FULL_ASSET_INFOS =
	"post_full_asset_info";
private static final String POST_REQUEST_GET_USER_INFO_SIZE =
	"post_user_info_size";
...
public static final String AUTOSYNC_PERIOD_LAST_NON_ZERO =
	"autosync.period.last";
...
public static final String NOTIFICATION_CHANGES_RATING =
	"notification.changes.rating";
public static final String NOTIFICATION_CHANGES_COMMENTS =
	"notification.changes.comments";
public static final String NOTIFICATION_CHANGES_DOWNLOADS =
	"notification.changes.download";
...
public static final String NOTIFICATION_WHEN_ACCOUNT_VISISBLE =
	"notification.when_account_visible";

public static final String DATE_FORMAT_LONG = "dateformat.long";

private static final String ADMOB_HIDE_FOR_UNCONFIGURED_APPS =
	"admob.hide_for_unconfigured_apps";
...
private static final String LAST_STATS_REMOTE_UPDATE =
	"last.stats.remote.update";
// 15 minutes in millis
public static final long STATS_REMOTE_UPDATE_INTERVAL = 15 * 60 * 1000L;

private static final String LAST_COMMENTS_REMOTE_UPDATE =
	"last.commentts.remote.update";
// make it shorter for comments 5 minutes in millis
public static final long COMMENTS_REMOTE_UPDATE_INTERVAL = 5 * 60 * 1000L;

public static final String USE_GOOGLE_TRANSLATE_APP =
	"use.google.translate.app";
public static final String SHOW_COMMENT_AUTO_TRANSLATIONS =
	"show.comment.auto.translations";

public static final String SHOW_DEVELOPER_CUT_REVENUE =
	"revenue.show.developer.cut";
...
public enum StatsMode { PERCENT, DAY_CHANGES }
...
@Deprecated
public static void saveAccountName(final Context activity,
...
public static void saveGwtPermutation(final Context activity,
                                      final String gwtPermutation) {
...
public static void saveLastNonZeroAutosyncPeriod(final Context activity,
...
public static int getAutosyncPeriod(final Context activity) {
	...
	return Integer.parseInt(getSettings(activity).getString(
					AUTOSYNC_PERIOD, Integer.toString(AutosyncHandler.DEFAULT_PERIOD)));
}

public static String getRequestFullAssetInfo(final Context activity) {
	return getVersionDependingProperty(POST_REQUEST_GET_FULL_ASSET_INFOS,
	                                   activity);
}

public static void saveRequestFullAssetInfo(final Context activity,
                                            final String postdata) {
	saveVersionDependingProperty(POST_REQUEST_GET_FULL_ASSET_INFOS, postdata,
	                             activity);
}

public static String getRequestGetAssetForUserCount(final Context context) {
	return getVersionDependingProperty(POST_REQUEST_GET_USER_INFO_SIZE,
	                                   context);
}

public static void saveRequestGetAssetForUserCount(final Context context,
                                                   final String string) {
	saveVersionDependingProperty(POST_REQUEST_GET_USER_INFO_SIZE, string,
	                             context);
}
...
public static void saveRequestUserComments(final Context context,
                                           final String string) {
	saveVersionDependingProperty(POST_REQUEST_USER_COMMENTS, string, context);
}

private static String getVersionDependingProperty(final String name,
                                                  final Context context) {
	return getSettings(context).getString(name + getAppVersionCode(context),
	                                      null);
}

private static void saveVersionDependingProperty(final String name,
                                                 final String value,
                                                 final Context context) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
public static void saveChartTimeframe(final Timeframe value,
                                      final Context context) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
public static Timeframe getChartTimeframe(final Context activity) {
	return Timeframe.valueOf(getSettings(activity).getString(
					 CHART_TIMEFRAME, Timeframe.LAST_THIRTY_DAYS.name()));
}
...
public static void saveSkipAutoLogin(final Context context,
                                     final Boolean value) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
public static void saveStatsMode(final StatsMode value,
                                 final Context context) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
public static StatsMode getStatsMode(final Context activity) {
	return StatsMode.valueOf(
		getSettings(activity).getString(STATS_MODE, StatsMode.PERCENT.name()));
}

public static boolean getNotificationPerf(final Context context,
...
public static void saveShowChartHint(final Context context,
                                     final Boolean value) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
private static String getDateFormatStringLong(final Context context) {
	...
	if ("DEFAULT".equals(format)) {
		format = ((SimpleDateFormat)DateFormat.getDateInstance(DateFormat.SHORT))
		         .toPattern();
...
@Deprecated
public static void saveAdmobSiteId(final Context context,
...
@Deprecated
public static String getAdmobSiteId(final Context context,
                                    final String packageName) {
	return getSettings(context).getString(ADMOB_SITE_ID + packageName, null);
}

@Deprecated
public static void saveAdmobAccount(final Context context,
                                    final String siteId,
                                    final String accountName) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
@Deprecated
public static String getAdmobAccount(final Context context,
                                     final String siteId) {
...
public static void saveLatestVersionCode(final Context context,
                                         final int latest) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
public static void saveRequestFeedback(final Context activity,
                                       final String postdata) {
...
public static Timeframe getAdmobTimeframe(final Context context) {
	return Timeframe.valueOf(getSettings(context).getString(
					 ADMOB_TIMEFRAME, Timeframe.LAST_THIRTY_DAYS.name()));
}

public static void saveAdmobTimeframe(final Timeframe value,
                                      final Context context) {
	SharedPreferences.Editor editor = getSettings(context).edit();
...
@Deprecated
public static void saveIsHiddenAccount(final Context context,
                                       final String accountName,
...
@Deprecated
public static boolean getIsHiddenAccount(final Context context,
                                         final String accountName) {
...
public static boolean getHideAdmobForUnconfiguredApps(final Context context) {
	return getSettings(context).getBoolean(ADMOB_HIDE_FOR_UNCONFIGURED_APPS,
	                                       false);
}

@Deprecated
public static synchronized long
getLastStatsRemoteUpdateTime(final Context activity,
                             final String accountName) {
	return getSettings(activity).getLong(
		LAST_STATS_REMOTE_UPDATE + "." + accountName, 0);
}

@Deprecated
public static synchronized void saveLastStatsRemoteUpdateTime(
	final Context activity, final String accountName, final long timestamp) {
	getSettings(activity)
	.edit()
	.putLong(LAST_STATS_REMOTE_UPDATE + "." + accountName, timestamp)
	.commit();
}

/**
 * Gets the last time that comments were updated for the given
 * <b>packageName</b>
 *
 * @param activity
 * @param packageName
...
@Deprecated
public static synchronized long
getLastCommentsRemoteUpdateTime(final Context activity,
                                final String packageName) {
	return getSettings(activity).getLong(
		LAST_COMMENTS_REMOTE_UPDATE + "." + packageName, 0);
}

/**
 * Sets the time that comments were last updated for the given
 * <b>packageName</b>
 *
 * @param activity
 * @param packageName
 ...
 */
@Deprecated
public static synchronized void saveLastCommentsRemoteUpdateTime(
	final Context activity, final String packageName, final long timestamp) {
	getSettings(activity)
	.edit()
	.putLong(LAST_COMMENTS_REMOTE_UPDATE + "." + packageName, timestamp)
	.commit();
}

public static synchronized boolean
isUseGoogleTranslateApp(final Context context) {
	return getSettings(context).getBoolean(USE_GOOGLE_TRANSLATE_APP, true);
}

public static synchronized void
saveUseGoogleTranslateApp(final Context context, final boolean value) {
	getSettings(context)
	.edit()
	.putBoolean(USE_GOOGLE_TRANSLATE_APP, value)
	.commit();
}

public static synchronized boolean
isShowCommentAutoTranslations(final Context context) {
	return getSettings(context).getBoolean(SHOW_COMMENT_AUTO_TRANSLATIONS,
	                                       true);
}

public static synchronized void
saveShowCommentAutoTranslations(final Context context, final boolean value) {
	getSettings(context)
	.edit()
	.putBoolean(SHOW_COMMENT_AUTO_TRANSLATIONS, value)
	.commit();
}

public static synchronized boolean
isShowDeveloperCutRevenue(final Context context) {
	return getSettings(context).getBoolean(SHOW_DEVELOPER_CUT_REVENUE, true);
}

public static synchronized void
saveShowDeveloperCutRevenue(final Context context, final boolean value) {
	getSettings(context)
	.edit()
	.putBoolean(SHOW_DEVELOPER_CUT_REVENUE, value)
	.commit();
}
}
