...
public class AdmobAccountAuthenticator extends Service {
  ...
  public static final String AUTHTOKEN_TYPE_ADMOB =
      "com.github.andlyticsproject.admob";
  public static final String ACCOUNT_TYPE_ADMOB =
      "com.github.andlyticsproject.admob";

  private static Authenticator sAccountAuthenticator = null;

  public AdmobAccountAuthenticator() { super(); }
  ...
  private static class Authenticator extends AbstractAccountAuthenticator {
    ...
    @Override
    public Bundle
    addAccount(final AccountAuthenticatorResponse response,
               final String accountType, final String authTokenType,
               final String[] requiredFeatures, final Bundle options) {
      final Intent intent =
          new Intent(mContext, AdmobAuthenticatorActivity.class);
    ...
    @Override
    public Bundle
    confirmCredentials(final AccountAuthenticatorResponse response,
      ...
      intent.putExtra(AdmobAuthenticatorActivity.PARAM_CONFIRM_CREDENTIALS,
                      true);
      intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE,
                      response);
      final Bundle bundle = new Bundle();
    ...
    public Bundle getAuthToken(final AccountAuthenticatorResponse response,
      ...
      if (!authTokenType.equals(
              AdmobAccountAuthenticator.AUTHTOKEN_TYPE_ADMOB)) {
        final Bundle result = new Bundle();
    ...
    public String getAuthTokenLabel(final String authTokenType) {
      if (authTokenType.equals(
        ...
        return mContext.getString(
            com.github.andlyticsproject.R.string.app_name_admob);
      }
      return null;
    }
     ...
     */
    private String onlineConfirmPassword(final String username,
                                         final String password) {
      return AdmobAuthenticationUtilities.authenticate(
          username, password, null /* Handler */, null /* Context */);
    }
