...
public class SyncAdapterService extends Service {
  ...
  public SyncAdapterService() { super(); }
  ...
  private static class SyncAdapterImpl extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(final Account account, final Bundle extras,
      ...
      DeveloperAccount developerAccount =
          DeveloperAccountManager.getInstance(mContext)
  ...
  private static void performSync(final Context context, final Account account,
    ...
    try {
      ...
      if (console != null) {
        ...
        Log.d(TAG,
              "andlytics from sync adapter, size: " + appDownloadInfos.size());
        ...
        for (AppInfo appDownloadInfo : appDownloadInfos) {
          ...
          String[] admobDetails =
              AndlyticsDb.getInstance(context).getAdmobDetails(
        ...
        if (!admobAccountSiteMap.isEmpty()) {
          ...
          for (String admobAccount : admobAccuntKeySet) {
            AdSenseClient.backgroundSyncStats(
        ...
        DeveloperAccountManager.getInstance(context)
            .saveLastStatsRemoteUpdateTime(account.name,
