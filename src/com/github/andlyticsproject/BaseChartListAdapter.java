...
public abstract class BaseChartListAdapter<T> extends BaseAdapter {
   ...
   */
  public abstract String getChartTitle(int page, int column)
      throws IndexOutOfBoundsException;
   ...
   * @throws IndexOutOfBoundsException
   */
  public abstract String getSubHeadLine(int page, int column)
      throws IndexOutOfBoundsException;
   ...
   * @throws IndexOutOfBoundsException
   */
  public abstract void updateChartValue(int position, int page, int column,
                                        TextView tv)
      throws IndexOutOfBoundsException;
  ...
  public BaseChartListAdapter(final Activity activity) {
    ...
    columnClickListener = new OnClickListener() {
      ...
      public void onClick(final View v) {
        ...
        ((ChartSwitcher)BaseChartListAdapter.this.activity)
            .setCurrentChart(currentPage, column);
      }
    };
  }
  ...
  static class ViewHolder {
    ...
    public ViewHolder(final int numFields) { fields = new TextView[numFields]; }
  }
  ...
  public final View getView(final int position, final View convertView,
    ...
    if (convertView == null) {
      convertView = activity.getLayoutInflater().inflate(
          R.layout.base_chart_list_item, null);
    ...
    if (usesSmooth) {
      holder.fields[holder.fields.length - 1].setVisibility(
          isSmothValue(currentPage, position) ? View.VISIBLE : View.INVISIBLE);
    }
  ...
  private TextView createTextView(final String string, final boolean bold,
    ...
    if (weight) {
      view.setLayoutParams(new LinearLayout.LayoutParams(
          LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, .2f));
    } else {
      view.setLayoutParams(new LinearLayout.LayoutParams(
  ...
  public abstract View buildChart(Context context, Chart baseChart,
                                  List<?> statsForApp, int page, int column)
      throws IndexOutOfBoundsException;
