...
public class AsyncTasks {
  ...
  public static class LoadAppListTask
      extends AsyncTask<String, Void, List<AppInfo>> {
    ...
    public void detach() { mCallback = null; }

    public List<AppInfo> getResult() { return mResult; }

    @Override
    protected List<AppInfo> doInBackground(final String... params) {
      return AndlyticsApp.getInstance().getDbAdapter().getAllAppsLatestStats(
          params[0]);
    }
