...
public final class AppStatsTable implements BaseColumns {
  ...
  public static final String TABLE_CREATE_STATS =
      "create table " + AppStatsTable.DATABASE_TABLE_NAME +
  ...
  static {
    ...
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_REQUESTDATE,
                       AppStatsTable.KEY_STATS_REQUESTDATE);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_DOWNLOADS,
                       AppStatsTable.KEY_STATS_DOWNLOADS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_INSTALLS,
                       AppStatsTable.KEY_STATS_INSTALLS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_COMMENTS,
    ...
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_5STARS,
                       AppStatsTable.KEY_STATS_5STARS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_4STARS,
                       AppStatsTable.KEY_STATS_4STARS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_3STARS,
                       AppStatsTable.KEY_STATS_3STARS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_2STARS,
                       AppStatsTable.KEY_STATS_2STARS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_1STARS,
                       AppStatsTable.KEY_STATS_1STARS);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_VERSIONCODE,
                       AppStatsTable.KEY_STATS_VERSIONCODE);
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_NUM_ERRORS,
    ...
    PROJECTION_MAP.put(AppStatsTable.KEY_STATS_CURRENCY,
