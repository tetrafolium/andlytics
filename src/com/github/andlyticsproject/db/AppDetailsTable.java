...
public static final String TABLE_CREATE_APP_DETAILS =
	"create table " + DATABASE_TABLE_NAME +
	" (_id integer primary key autoincrement, " + DESCRIPTION +
	" text not null, " + CHANGELOG + " text," + LAST_STORE_UPDATE +
	" date not null, " + APPINFO_ID +
	" integer not null, foreign key(appinfo_id) references appinfo(_id))";

public static final String[] ALL_COLUMNS = {ROWID, DESCRIPTION, CHANGELOG,
	                                    LAST_STORE_UPDATE, APPINFO_ID};
}
