...
public static final String TABLE_CREATE_COMMENTS =
	"create table " + DATABASE_TABLE_NAME +
	" (_id integer primary key autoincrement, " + KEY_COMMENT_PACKAGENAME +
	" text not null," + KEY_COMMENT_DATE + " text not null," +
	KEY_COMMENT_USER + " text," + KEY_COMMENT_DEVICE + " text," +
	KEY_COMMENT_APP_VERSION + " text," + KEY_COMMENT_TITLE +
	" text not null," + KEY_COMMENT_TEXT + " text not null," +
	KEY_COMMENT_RATING + " integer," + KEY_COMMENT_REPLY_TEXT + " text," +
	KEY_COMMENT_REPLY_DATE + " text, " + KEY_COMMENT_LANGUAGE + " text," +
	KEY_COMMENT_ORIGINAL_TITLE + " text, " + KEY_COMMENT_ORIGINAL_TEXT +
	" text, " + KEY_COMMENT_UNIQUE_ID + " text)";
...
static {
	...
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_TITLE,
	                   CommentsTable.KEY_COMMENT_TITLE);
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_TEXT,
	                   CommentsTable.KEY_COMMENT_TEXT);
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_DATE,
	                   CommentsTable.KEY_COMMENT_DATE);
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_USER,
	                   CommentsTable.KEY_COMMENT_USER);
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_RATING,
	...
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_DEVICE,
	...
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_LANGUAGE,
	                   CommentsTable.KEY_COMMENT_LANGUAGE);
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_ORIGINAL_TITLE,
	...
	PROJECTION_MAP.put(CommentsTable.KEY_COMMENT_UNIQUE_ID,
