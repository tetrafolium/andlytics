...
public final class AdmobTable implements BaseColumns {
  ...
  public static final String TABLE_CREATE_ADMOB =
      "create table " + AdmobTable.DATABASE_TABLE_NAME +
      " (_id integer primary key autoincrement, " + AdmobTable.KEY_SITE_ID +
      " text not null," + AdmobTable.KEY_REQUESTS + " integer," +
      AdmobTable.KEY_HOUSEAD_REQUESTS + " integer," +
      AdmobTable.KEY_INTERSTITIAL_REQUESTS + " integer," +
      AdmobTable.KEY_IMPRESSIONS + " integer," + AdmobTable.KEY_FILL_RATE +
      " float," + AdmobTable.KEY_HOUSEAD_FILL_RATE + " float," +
      AdmobTable.KEY_OVERALL_FILL_RATE + " float," + AdmobTable.KEY_CLICKS +
      " integer," + AdmobTable.KEY_HOUSEAD_CLICKS + " integer," +
      AdmobTable.KEY_CTR + " float," + AdmobTable.KEY_ECPM + " float," +
      AdmobTable.KEY_REVENUE + " float," + AdmobTable.KEY_CPC_REVENUE +
      " float," + AdmobTable.KEY_CPM_REVENUE + " float," +
