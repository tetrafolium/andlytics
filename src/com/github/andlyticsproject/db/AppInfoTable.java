...
public class AppInfoTable {
  ...
  public static final Uri CONTENT_URI =
      Uri.parse("content://" + AndlyticsContentProvider.AUTHORITY + "/" +
                DATABASE_TABLE_NAME);
  public static final Uri UNIQUE_PACAKGES_CONTENT_URI =
      Uri.parse("content://" + AndlyticsContentProvider.AUTHORITY + "/" +
                UNIQUE_PACKAGE_NAMES);

  public static final String CONTENT_TYPE =
      "vnd.android.cursor.dir/vnd.andlytics." + DATABASE_TABLE_NAME;
  ...
  public static final String KEY_APP_LAST_COMMENTS_UPDATE =
      "lastcommentsupdate";
  ...
  public static final String TABLE_CREATE_APPINFO =
      "create table " + DATABASE_TABLE_NAME +
      " (_id integer primary key autoincrement, " + KEY_APP_PACKAGENAME +
      " text not null," + KEY_APP_ACCOUNT + " text not null," +
      KEY_APP_LASTUPDATE + " date," + KEY_APP_NAME + " text," +
      KEY_APP_ICONURL + " text," + KEY_APP_CATEGORY + " text," +
      KEY_APP_PUBLISHSTATE + " integer," + KEY_APP_GHOST + " integer," +
      KEY_APP_RATINGS_EXPANDED + " integer," + KEY_APP_SKIP_NOTIFICATION +
      " integer," + KEY_APP_VERSION_NAME + " text, " + KEY_APP_ADMOB_ACCOUNT +
      " text, " + KEY_APP_ADMOB_SITE_ID + " text, " + KEY_APP_ADMOB_AD_UNIT_ID +
      " text, " + KEY_APP_LAST_COMMENTS_UPDATE + " date, " +
  ...
  static {
    ...
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_PACKAGENAME,
                       AppInfoTable.KEY_APP_PACKAGENAME);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_ACCOUNT,
                       AppInfoTable.KEY_APP_ACCOUNT);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_LASTUPDATE,
                       AppInfoTable.KEY_APP_LASTUPDATE);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_NAME, AppInfoTable.KEY_APP_NAME);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_CATEGORY,
                       AppInfoTable.KEY_APP_CATEGORY);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_PUBLISHSTATE,
                       AppInfoTable.KEY_APP_PUBLISHSTATE);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_ICONURL,
    ...
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_VERSION_NAME,
                       AppInfoTable.KEY_APP_VERSION_NAME);

    PROJECTION_MAP.put(AppInfoTable.KEY_APP_ADMOB_ACCOUNT,
                       AppInfoTable.KEY_APP_ADMOB_ACCOUNT);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_ADMOB_SITE_ID,
    ...
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_DEVELOPER_ID,
                       AppInfoTable.KEY_APP_DEVELOPER_ID);
    PROJECTION_MAP.put(AppInfoTable.KEY_APP_DEVELOPER_NAME,
                       AppInfoTable.KEY_APP_DEVELOPER_NAME);

    PACKAGE_NAMES_MAP = new HashMap<String, String>();
    PACKAGE_NAMES_MAP.put(AppInfoTable.KEY_APP_PACKAGENAME,
                          AppInfoTable.KEY_APP_PACKAGENAME);
  }
}
