...
@ReportsCrashes(sharedPreferencesMode = Context.MODE_PRIVATE,
...
public class AndlyticsApp extends Application {
  ...
  private void initAcra() {
    try {
      ...
      HttpSender bugSenseSender = new HttpSender(
          HttpSender.Method.POST, HttpSender.Type.FORM, bugsenseUrl, null);
  ...
  public static AndlyticsApp getInstance() { return sInstance; }
  ...
  public void setDbAdapter(final ContentAdapter db) { this.db = db; }

  public ContentAdapter getDbAdapter() { return db; }
}
