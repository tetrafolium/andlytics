...
public class Revenue {
  ...
  public enum Type { TOTAL, APP_SALES, IN_APP, SUBSCRIPTIONS }
  ...
  public Revenue(final Type type, final double amount,
  ...
  public double getDeveloperCut() { return developerCut; }

  @SuppressLint("DefaultLocale")
  public String asString() {
    if (NO_DECIMAL_CURRENCIES.contains(currencyCode)) {
      return String.format(NO_DECIMALS_CURRENCY_FORMAT, currency.getSymbol(),
                           amount);
    }

    return String.format((amount < DECIMAL_DISPLAY_THRESHOLD
                              ? DECIMAL_CURRENCY_FORMAT
                              : NO_DECIMALS_CURRENCY_FORMAT),
  ...
  public String developerCutAsString() {
    ...
    return String.format((amount < DECIMAL_DISPLAY_THRESHOLD
                              ? DECIMAL_CURRENCY_FORMAT
                              : DECIMAL_CURRENCY_FORMAT),
                         currency.getSymbol(), developerCut);
  }
