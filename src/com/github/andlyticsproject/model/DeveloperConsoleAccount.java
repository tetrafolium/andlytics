...
public class DeveloperConsoleAccount {
  ...
  public DeveloperConsoleAccount(final String developerId, final String name,
                                 final boolean canAccessApps) {
  ...
  public boolean getCanAccessApps() { return canAccessApps; }
  ...
  public String toString() {
    return String.format(
        "DeveloperConsoleAccount [developerId=%s, name=%s, canAccessApps=%b]",
