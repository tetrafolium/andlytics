...
public class AppStats extends Statistic {
  ...
  public AppStats(final AppStats appStats) {
    ...
    this.setActiveInstallsPercentString(
  ...
  public int getDailyDownloads() { return dailyDownloads; }

  public void setDailyDownloads(final int dailyDownloads) {
    this.dailyDownloads = dailyDownloads;
  }

  public boolean isSmoothingApplied() { return smoothingApplied; }

  public void setSmoothingApplied(final boolean smoothingApplied) {
    this.smoothingApplied = smoothingApplied;
  }

  public void setRating(final Integer rating1, final Integer rating2,
                        final Integer rating3, final Integer rating4,
  ...
  public String getAvgRatingString() { return this.avgRatingString; }
  ...
  public void calsRatingPercentStrings() {
    ...
    for (int i = 1; i < 6; i++) {
      ...
      ratingBigDecimal =
          ratingBigDecimal.setScale(2, BigDecimal.ROUND_HALF_EVEN);
  ...
  public Integer getRating1() { return rating1; }

  public void setRating1(final Integer rating1) { this.rating1 = rating1; }

  public Integer getRating2() { return rating2; }

  public void setRating2(final Integer rating2) { this.rating2 = rating2; }

  public Integer getRating3() { return rating3; }

  public void setRating3(final Integer rating3) { this.rating3 = rating3; }

  public Integer getRating4() { return rating4; }

  public void setRating4(final Integer rating4) { this.rating4 = rating4; }

  public Integer getRating5() { return rating5; }

  public Integer getRating1Diff() { return rating1Diff; }

  public void setRating1Diff(final Integer rating1Diff) {
    this.rating1Diff = rating1Diff;
  }

  public Integer getRating2Diff() { return rating2Diff; }

  public void setRating2Diff(final Integer rating2Diff) {
    this.rating2Diff = rating2Diff;
  }

  public Integer getRating3Diff() { return rating3Diff; }

  public void setRating3Diff(final Integer rating3Diff) {
    this.rating3Diff = rating3Diff;
  }

  public Integer getRating4Diff() { return rating4Diff; }

  public void setRating4Diff(final Integer rating4Diff) {
    this.rating4Diff = rating4Diff;
  }

  public Integer getRating5Diff() { return rating5Diff; }

  public void setRating5Diff(final Integer rating5Diff) {
    this.rating5Diff = rating5Diff;
  }

  public void setRating5(final Integer rating5) { this.rating5 = rating5; }

  public void setAvgRatingDiff(final float avgRatingDiff) {
    this.avgRatingDiff = avgRatingDiff;
  }

  public float getAvgRatingDiff() { return avgRatingDiff; }

  public void setRatingCountDiff(final int ratingCountDiff) {
    this.ratingCountDiff = ratingCountDiff;
  }

  public int getRatingCountDiff() { return ratingCountDiff; }

  public void setAvgRatingDiffString(final String avgRatingDiffString) {
    this.avgRatingDiffString = avgRatingDiffString;
  }

  public String getAvgRatingDiffString() { return avgRatingDiffString; }

  public void setNumberOfCommentsDiff(final int numberOfCommentsDiff) {
    this.numberOfCommentsDiff = numberOfCommentsDiff;
  }

  public int getNumberOfCommentsDiff() { return numberOfCommentsDiff; }

  public void setActiveInstallsDiff(final int activeInstallsDiff) {
    this.activeInstallsDiff = activeInstallsDiff;
  }

  public int getActiveInstallsDiff() { return activeInstallsDiff; }
  ...
  public void
  setActiveInstallsPercentString(final String activeInstallsPercentString) {
  ...
  public Revenue getTotalRevenue() { return totalRevenue; }

  public void setTotalRevenue(final Revenue totalRevenue) {
    this.totalRevenue = totalRevenue;
  }

  public AppStatsDiff createDiff(final AppStats previousStats,
