...
public class CommentGroup {
  ...
  public CommentGroup(final Date date) { setDate(date); }
  ...
  public Date getDate() { return date = (Date)date.clone(); }
  ...
  public String getFormattedDate() { return yyyymmddDate; }

  public List<Comment> getComments() { return comments; }

  public void addComment(final Comment comment) { comments.add(comment); }
