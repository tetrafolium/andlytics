...
public class AppDetails {
  ...
  public AppDetails(final String description, final String changelog,
                    final Date lastStoreUpdate) {
    this.description = description;
    this.changelog = changelog;
    this.lastStoreUpdate =
        lastStoreUpdate == null ? null : (Date)lastStoreUpdate.clone();
  }

  public AppDetails(final String description, final String changelog,
                    final Long lastStoreUpdate) {
    this.description = description;
    this.changelog = changelog;
    this.lastStoreUpdate =
        lastStoreUpdate == null ? null : new Date(lastStoreUpdate);
  }
  ...
  public void setLinks(final List<Link> links) { this.links = links; }

  public void addLink(final Link link) { links.add(link); }
}
