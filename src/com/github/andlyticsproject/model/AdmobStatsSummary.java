...
public class AdmobStatsSummary extends StatsSummary<AdmobStats> {
  ...
  public AdmobStatsSummary() { overallStats = new AdmobStats(); }
  ...
  public void addStat(final AdmobStats stat) {
    ...
    overallStats.setCpcRevenue(overallStats.getCpcRevenue() +
                               stat.getCpcRevenue());
    overallStats.setCpmRevenue(overallStats.getCpmRevenue() +
                               stat.getCpmRevenue());
    ...
    overallStats.setHouseAdClicks(overallStats.getHouseAdClicks() +
                                  stat.getHouseAdClicks());
    ...
    overallStats.setImpressions(overallStats.getImpressions() +
                                stat.getImpressions());
    overallStats.setInterstitialRequests(
        overallStats.getInterstitialRequests() +
