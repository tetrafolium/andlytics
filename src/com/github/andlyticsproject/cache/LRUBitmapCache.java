...
public class LRUBitmapCache {
  ...
  public LRUBitmapCache(final int cacheSize) {
    ...
    int hashTableCapacity =
        (int)FloatMath.ceil(cacheSize / hashTableLoadFactor) + 1;
    map = new LinkedHashMap<String, Bitmap>(hashTableCapacity,
   ...
   */
  public synchronized Bitmap get(final String key) { return map.get(key); }
