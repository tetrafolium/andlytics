...
public class DevConsoleRegistry {
  ...
  private Map<String, DevConsoleV2> registry =
      new HashMap<String, DevConsoleV2>();

  private static DevConsoleRegistry instance = new DevConsoleRegistry();

  private DevConsoleRegistry() {}

  public static DevConsoleRegistry getInstance() { return instance; }

  public synchronized void put(final String accountName,
                               final DevConsoleV2 devConsole) {
  ...
  public synchronized DevConsoleV2 get(final String accountName) {
    ...
    if (result == null) {
      DefaultHttpClient httpClient =
          HttpClientFactory.createDevConsoleHttpClient(DevConsoleV2.TIMEOUT);
