...
public class HttpClientFactory {
  ...
  private static final String ANDROID_BROWSER_USER_AGENT =
  ...
  private static final String ACCEPT_CHARSET_VALUE =
  ...
  createDevConsoleHttpClient(final int timeoutMillis) {
  ...
  createDefaultClient(final int timeoutMillis) {
  ...
  static class InflatingEntity extends HttpEntityWrapper {
    public InflatingEntity(final HttpEntity wrapped) { super(wrapped); }
