...
public class DevConsoleProtocolException extends DevConsoleException {
  ...
  public DevConsoleProtocolException(final String message) { super(message); }
  ...
  public DevConsoleProtocolException(final Throwable cause) { super(cause); }
  ...
  public String getConsoleResponse() { return consoleResponse; }
}
