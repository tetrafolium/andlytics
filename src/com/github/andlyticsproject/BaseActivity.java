...
public class BaseActivity extends AppCompatActivity {
  ...
  public static final String EXTRA_AUTH_ACCOUNT_NAME =
      "com.github.andlyticsproject.accontname";
  public static final String EXTRA_PACKAGE_NAME =
      "com.github.andlyticsproject.packagename";
  public static final String EXTRA_DEVELOPER_ID =
      "com.github.andlyticsproject.developerid";
  public static final String EXTRA_ICON_FILE =
      "com.github.andlyticsproject.iconfile";
  ...
  public void startActivity(final Class<?> clazz,
                            final boolean disableAnimation,
                            final boolean skipDataReload) {
  ...
  public void handleUserVisibleException(final Exception e) {
    if (e instanceof NetworkException) {
      Toast
          .makeText(BaseActivity.this, getString(R.string.network_error),
                    Toast.LENGTH_LONG)
          .show();
    } else if (e instanceof AppAccessBlockedException) {
      Toast
          .makeText(BaseActivity.this,
                    getString(R.string.app_access_blocked_error, accountName),
                    Toast.LENGTH_LONG)
          .show();
      ...
      Toast
          .makeText(BaseActivity.this,
                    getString(R.string.admob_ratelimit_error),
                    Toast.LENGTH_LONG)
          .show();
      ...
      Toast
          .makeText(BaseActivity.this,
                    getString(R.string.admob_missing_error, wrongAccount),
                    Toast.LENGTH_LONG)
          .show();
    } else if (e instanceof AdmobInvalidRequestException) {
      Toast
          .makeText(BaseActivity.this,
                    getString(R.string.admob_invalid_request_error),
                    Toast.LENGTH_LONG)
          .show();
    } else if (e instanceof AdmobInvalidTokenException) {
      Toast
          .makeText(BaseActivity.this,
                    getString(R.string.admob_invalid_token_error),
                    Toast.LENGTH_LONG)
          .show();
    } else if (e instanceof AdmobGenericException) {
      Log.w(TAG, e.getMessage(), e);
      Toast
          .makeText(BaseActivity.this, getString(R.string.admob_generic_error),
                    Toast.LENGTH_LONG)
          .show();
            ...
            public void onClick(final DialogInterface dialog, final int which) {
              ...
              goToMarket =
                  new Intent(Intent.ACTION_VIEW,
                             Uri.parse(getString(R.string.market_uri)));
  ...
  protected void showAspErrorDialog(final Exception e) {
    ...
    if (!isFinishing()) {
      ...
      builder.setPositiveButton(
          getString(R.string.logout), new DialogInterface.OnClickListener() {
            public void onClick(final DialogInterface dialog, final int which) {
              dialog.dismiss();
  ...
  public boolean shouldRemoteUpdateStats() {
    ...
    long lastUpdate =
        developerAccountManager.getLastStatsRemoteUpdateTime(accountName);
    // never updated
    if (lastUpdate == 0) {
      return true;
    }
  ...
  protected boolean isSkipMainReload() { return skipMainReload; }
    ...
    runOnUiThread(new Runnable() {
      public void run() {
        Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
            connectionStatusCode, BaseActivity.this,
